...
export default function QuestDetailClient({ questId }: { questId: string }) {
  ...
  const handleCompleteQuest = async () => {
    ...
    try {
      ...
      toast({
        ...
        description:
          "You've successfully completed the quest and earned a badge!",
      });
  ...
  const allStepsCompleted =
    completingSteps.length === quest.steps.length &&
    completingSteps.every((step) => step === true);
            ...
            <div className="md:col-span-2 space-y-6">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Complete these steps to finish the quest
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
                    {quest.steps.map((step, index) => (
                      <div
                        ...
                        onClick={() =>
                          !isCompleted && toggleStepCompletion(index)
                        }
                      >
                        {isCompleted ? (
                ...
                <CardFooter className="flex flex-col gap-3">
                  {isCompleted ? (
                    ...
                    <Button
                      className="w-full"
                      disabled={
                        !allStepsCompleted || isSubmitting || !isConnected
                      }
