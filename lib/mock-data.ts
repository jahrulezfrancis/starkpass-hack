...
export const mockBadges: Badge[] = [
  ...
  },
  {
    ...
    image: "https://i.ibb.co/1fkFcvcZ/SN-Symbol-Gradient.png?height=200&width=200",
    issuer: "StarkPass",
    issuedAt: new Date("2025-02-20").toISOString(),
  },
  {
    id: "badge-3",
    ...
    issuedAt: new Date("2025-03-10").toISOString(),
  },
]
...
export const mockCredentials: Credential[] = [
  {
    ...
    issuer: "Starknet Foundation",
    issuedAt: new Date("2025-04-05").toISOString(),
    tokenId: "1234",
  ...
  },
  {
    ...
    issuer: "StarkWare",
    issuedAt: new Date("2025-05-12").toISOString(),
    tokenId: "5678",
    contractAddress: "0x1234567890abcdef",
  },
  {
    ...
    image: "https://i.ibb.co/1fkFcvcZ/SN-Symbol-Gradient.png?height=300&width=300",
    issuer: "Starknet Foundation",
    issuedAt: new Date("2025-06-20").toISOString(),
    tokenId: "9012",
    contractAddress: "0x1234567890abcdef",
  },
]
...
export const mockCampaigns: Campaign[] = [
  {
    id: "campaign-1",
    title: "Starknet Hackathon 2025 POAP",
    description: "Claim your POAP for participating in the Starknet Hackathon 2025",
    sponsor: "Starknet Foundation",
    sponsorLogo: "https://i.ibb.co/1fkFcvcZ/SN-Symbol-Gradient.png?height=100&width=100",
...
export const mockEcosystemStats = {
  ...
  successfulCampaigns: [
    { id: "campaign-1", title: "Starknet Hackathon 2025 POAP", claimRate: "50%" },
